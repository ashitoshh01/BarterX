...
const AIMatches = () => {
  ...
  return (
    <div className="space-y-6" data-testid="matches-page">
      {/* Header Banner */}
      <div className="nb-card p-8 md:p-10 relative overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--surface)] via-[var(--surface-2)] to-black border border-white/10">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] text-white">
          ...
          {aiMatches.map((m, i) => {
            ...
            return (
              <motion.div
                ...
                className="nb-card p-5 md:p-6 bg-[var(--surface)] border border-white/10 hover:border-white/20 transition-all rounded-2xl shadow-xl"
                data-testid={`match-card-${m.id}`}
              >
                {/* Header Row: Score Badge, Match Title, View Action */}
                <div className="flex items-center justify-between mb-5 flex-wrap gap-4 pb-4 border-b border-white/10">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--lime)] text-black flex items-center justify-center font-mono2 font-black text-sm shrink-0 border-2 border-black shadow-[2px_2px_0_0_#000] overflow-hidden">
                    ...
                    <div>
                      ...
                      <div className="font-display text-xl sm:text-2xl font-bold text-white flex items-center gap-2 flex-wrap">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 items-center">
                  {/* YOU OFFER */}
                  <div className="bg-[var(--surface-2)] border border-white/10 rounded-xl p-4 transition-all hover:border-white/20">
                    ...
                    <div className="flex gap-3.5 items-center">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="font-display text-base font-semibold text-white truncate">{yourItem.title}</div>
                  ...
                  <div className="bg-[var(--surface-2)] border border-white/10 rounded-xl p-4 transition-all hover:border-white/20">
                    ...
                    <div className="flex gap-3.5 items-center">
                      ...
                      />
                      <div className="min-w-0 flex-1">
                        <div className="font-display text-base font-semibold text-white truncate">{theirItem.title}</div>
                        <div className="text-xs text-[var(--text-2)] mt-0.5 flex items-center gap-2 flex-wrap">
                          <span className="font-medium text-white">{owner?.handle || owner?.name || "@swapper"}</span>
                ...
                <div className="mt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-black/40 border border-white/10 rounded-xl p-3.5">
                  <div className="flex items-center gap-2 text-xs text-gray-300">
                    <Sparkles size={14} className="text-[var(--lime)] shrink-0" />
                    <span><strong className="text-white font-semibold">Why match: </strong>{m.reason}</span>
                  </div>
